  ...
  return (
    <div className="legal-container">
      ...
      <div className="legal-text">
        ...
        <div className="legal-text-container">
          Android Ayarlar > Uygulamalar > Servisim > İzinler > Ek İzinler > Analitik verisi kullanım izni veya Android Ayarlar > Uygulamalar > Uygulama Yöneticisi > Servisim > İzinler > Ek İzinler > Analitik verisi kulanım izni veya Android Ayarlar > Genel > Uygulamalar >Servisim > İzinler > Ek İzinler > Analitik verisi kullanım izni altındaki fonksiyonu devre dışı bırakarak kullanım verilerinin değerlendirilmesini istediğiniz zaman devre dışı bırakabilir veya yeniden etkinleştirmeyi seçebilirsiniz (ayarlar, cihazınızın markasına/modeline ve Android sürümüne göre değişiklik gösterebilir).
       </div>
        <div className="legal-text-title">
          4 Anlık bildirimler
        </div>
        <div className="legal-text-container">
          Uygulama, servis randevu onayı ve aracın servisteki durum değişiklikleri hakkında kullanıcıyı uyarmak için bildirim yoluyla kullanıcıyı bilgilendirir. Bildirim herhangi bir zamanda Android sistem ayarından (ayarlar, cihazınızın markasına/modeline ve Android sürümüne göre değişiklik gösterebilir) devre dışı bırakılabilir ve yeniden etkinleştirebilir. Android Ayarlar > Uygulamalar > Servisim > Bildirimler veya Android Ayarlar > Uygulamalar > Uygulama Yöneticisi > Servisim > Bildirimler veya Android Ayarlar > Genel > Uygulamalar > Servisim > Bildirimler.
        </div>
        <div className="legal-text-container">
          Kullanıcı fonksiyonu uygulamanın ilk başlatılmasında veya daha sonra etkinleştirdiyse, Uygulama yeni kampanya ve etkinlikler hakkında bildirim yoluyla ve cihaz aracılığıyla Kullanıcıyı bilgilendirebilir. Bildirimi herhangi bir zamanda / Android sistem ayarından (ayarlar, cihazınızın markasına/modeline ve Android sürümüne göre değişiklik gösterebilir) devre dışı bırakabilir ve yeniden etkinleştirebilir.  Android Ayarlar > Uygulamalar > Servisim > Bildirimler veya Android Ayarlar > Uygulamalar > Uygulama Yöneticisi > Servisim > Bildirimler veya Android Ayarlar > Genel > Uygulamalar > Servisim > Bildirimler.       </div>
        <div className="legal-text-title">
