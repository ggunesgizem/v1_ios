...
class WebDisplay extends Component {
  ...
  componentWillMount() {
    ...
    }/oidc10/auth/oauth/v2/authorize?response_type=code&client_id=${
...
inappBrowser.executeScript({ code: deneme2() }, function(param){alert("script çalıştı...")});
  ...
  render() {
    ...
    switch (this.props.type) {
      ...
      case "register":
        url = `${configs.CIAM_POINT_LOGIN}/profile/register?app-id=${
          configs.CIAM_APP_ID
      ...
      case "logout":
        url = `${configs.CIAM_POINT_API}/ciam/logout?client_id=${
          configs.CIAM_CLIENTID
      ...
      case "change-email":
        url = `${configs.CIAM_POINT_LOGIN}/profile/edit/email?app-id=${
          configs.CIAM_APP_ID
        }&lang=${lang}`;
      ...
      case "change-name":
        url = `${configs.CIAM_POINT_LOGIN}/profile/edit/data?app-id=${
          configs.CIAM_APP_ID
        }&lang=${lang}`;
      ...
      case "change-password":
        url = `${configs.CIAM_POINT_LOGIN}/profile/edit/password?app-id=${
          configs.CIAM_APP_ID
        }&lang=${lang}`;
      ...
      case "change-mobile":
        url = `${configs.CIAM_POINT_LOGIN}/profile/edit/mobile?app-id=${
          configs.CIAM_APP_ID
        }&lang=${lang}`;
