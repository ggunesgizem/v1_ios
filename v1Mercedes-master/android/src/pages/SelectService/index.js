...
class SelectService extends Component {
  ...
  renderEach(fieldConfig, field) {
    ...
    {
      return (
        <div style={{textAlign:'left',borderColor:'black',borderWidth:2,height:130,borderStyle:'solid',color:'black',margin:10,fontSize:18,padding:10,fontFamily:'CorpoS_Light,Times,serif'}}>
          {fieldConfig.label}
        </div>
      );
    }
