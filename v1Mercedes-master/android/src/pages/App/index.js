...
class App extends Component {
  constructor(props) {
    ...
    if(window.rootdetection) {
      window.rootdetection.isDeviceRooted(
        result => {
          if (result) {
            // console.log('jailBroken: ' + result)
            navigator.notification.confirm(
              'Your device is rooted. Do you want to continue to use this app?',         // message
              this.jailBreakCallback, // callback
              'Root detection',           // title
              ['Yes', 'Exit'] // buttonName
            )
          }
        },
...
*/
  ...
  render() {
    ...
    //Turkish Yazan kısımdaki locales_en i locales_tur yap ve moment.locale i tr yap Turkce icin
              ...
              {this.props.isLogin ?
                <div style={{ width: '100%', height: '100%' }}>
                  <div id="mainPageContainer">
                    ...
                    {/* Alt satirdaki !== kısmını === yap turkce icin*/}
                      ...
                      {/* Ust taraftaki mantıksal eşitliğin tersi alt satıra uygulanacak. */}
                      <div className="main_navigation_container_child" style={{ display: this.props.selectedLanguage !== "ENGLISH" ? "flex" : "none" }}>
                        <div className="main_nav_button_container" onClick={this.switchMains.bind(this, 1)}>
