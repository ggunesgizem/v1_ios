  ...
  return(
    <span>
      ...
      <div className="legal-text">
        ...
        <div className="legal-text-title">
          2 Kişisel Verilerin Transferi Devri
        </div>
        <div className="legal-text-container">
        2.1 Uygulama ile bağlantılı olarak üçüncü şahıs hizmetlerinin (Google Maps, Whatsapp) kullanılması halinde Yayıncı, Uygulamanın ilgili işlevleri için gerektiği kadarıyla kişisel verileri üçüncü şahıs sağlayıcıya aktarma hakkına sahip olacaktır.
        </div>
        <div className="legal-text-container">
        2.2 Bu amaçla kişisel Kullanıcı verileri EU/EWR dışındaki şu ülkelere de aktarılabilir: Singapur ve Türkiye.
        </div>
        <div className="legal-text-container">
        2.3 Kişisel veriler yalnızca geçerli zorunlu ulusal kanunlar kapsamında gerekmesi halinde kamu kurum ve yetkililerine aktarılabilecektir.
        </div>
        <div className="legal-text-title">
          3. Bildirim Gönderme
        </div>
        <div className="legal-text-container">
        3.1 Uygulama, servis randevu onayı ve aracın servisteki durum değişiklikleri hakkında kullanıcıyı uyarmak için bildirim yoluyla kullanıcıyı bilgilendirir. Bildirim, herhangi bir zamanda / Android sistem ayarlarından (ayarlar, cihazınızın markasına/modeline ve Android sürümüne göre değişiklik gösterebilir) herhangi bir zamanda devre dışı bırakılabilir ve yeniden etkinleştirilebilir. Android Ayarlar > Uygulamalar > Servisim > Bildirimler veya Android Ayarlar > Uygulamalar > Uygulama Yöneticisi > Servisim > Bildirimler veya Android Ayarlar > Genel > Uygulamalar > Servisim > Bildirimler.
        </div>
        <div className="legal-text-container">
        3.2 Kullanıcı fonksiyonu uygulamanın ilk başlatılmasında veya daha sonra etkinleştirdiyse, Uygulama yeni kampanya ve etkinlikler hakkında bildirim yoluyla ve cihaz aracılığıyla Kullanıcıyı bilgilendirebilir. Bildirim, herhangi bir zamanda / Android sistem ayarlarından (ayarlar, cihazınızın markasına/modeline ve Android sürümüne göre değişiklik gösterebilir) herhangi bir zamanda devre dışı bırakılabilir ve yeniden etkinleştirilebilir. Android Ayarlar > Uygulamalar > Servisim > Bildirimler veya Android Ayarlar > Uygulamalar > Uygulama Yöneticisi > Servisim > Bildirimler veya Android Ayarlar > Genel > Uygulamalar > Servisim > Bildirimler.
        </div>
        <div className="legal-text-title">
          4     Veri Koruma Konuları için İletişim Kişisi
        </div>
        <div className="legal-text-container">
