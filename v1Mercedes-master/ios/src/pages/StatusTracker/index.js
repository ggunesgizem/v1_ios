  ...
  feedbackCallBackSuccess(status){
    if(navigator.notification){
      ...
      navigator.notification.alert(
          T.translate("my vehicle.status tracker.handover.feedback navigator.Add feedback success message"),  // message
          ()=>{
          ...
          '',            // title
          T.translate("my vehicle.status tracker.handover.feedback navigator.Add feedback success close")                  // buttonName
      );
    }else{
      //alert("Feedback Sent")
      this.toggleFeedback()
